package com.kuro.mdp.charts.bars
...
import com.kuro.mdp.charts.bars.modifier.drawAxisLineForVerticalChart
import com.kuro.mdp.charts.bars.modifier.drawRangeLinesForVerticalChart
import com.kuro.mdp.charts.bars.modifier.drawYAxisLabel
import com.kuro.mdp.charts.common.ChartColor
import com.kuro.mdp.charts.common.LabelConfig
import com.kuro.mdp.charts.common.TargetConfig
import com.kuro.mdp.charts.common.asSolidChartColor
import com.kuro.mdp.charts.common.drawTargetLineIfNeeded
import com.kuro.mdp.charts.common.getDrawingPath
...
private fun BarChartContent(
    ...
    val bottomPadding = if (labelConfig.showXLabel && !hasNegativeValues) 12.dp else 0.dp
    ...
    BarChartCanvasScaffold(
        ...
        displayData.fastForEachIndexed { index, barData ->
            val height =
                if (maxValue == 0f) 0f else barData.yValue / maxValue * canvasHeight
            ...
            if (isClickInsideBar(
                    clickedOffset, individualBarTopLeft, individualBarRectSize
                )
            ) {
                clickedBarIndex = index
                onBarClick(index, barData)
                val clickedTextLayoutResult = textMeasurer.measure(
                ...
                drawText(
                    textLayoutResult = clickedTextLayoutResult,
                    brush = Brush.linearGradient(labelConfig.textColor.value),
                    topLeft = Offset(
                        x = individualBarTopLeft.x + barWidth / 2 - clickedTextLayoutResult.size.width / 2,
                        y = individualBarTopLeft.y - 20.dp.toPx(),
                    ),
                )
            }
...
private fun getBarTopLeftAndRectSize(
    ...
    val individualBarTopLeft = Offset(
        x = index * (barWidth + gap) - barWidthAdjustment / 2, y = if (barData.yValue < 0) {
            topLeftY
        } else {
