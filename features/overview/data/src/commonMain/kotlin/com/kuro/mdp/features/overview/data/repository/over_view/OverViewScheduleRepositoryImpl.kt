...
import com.kuro.mdp.features.overview.domain.mapper.templates.convertToTimeTask
 ...
 * Description:
 */
class OverViewScheduleRepositoryImpl(
    private val scheduleRepository: ScheduleRepository,
    private val overViewFeatureScheduleRepository: OverViewFeatureScheduleRepository,
    private val templatesRepository: TemplatesRepository,
    private val statusChecker: ScheduleStatusChecker,
    private val dateManager: DateManager,
    private val overlayManager: TimeOverlayManager
) : OverViewScheduleRepository {
    ...
    override suspend fun fetchFeatureScheduleDate(): LocalDateTime? {
        return overViewFeatureScheduleRepository.fetchScheduleDate().apply {
            overViewFeatureScheduleRepository.setScheduleDate(null)
        }
    }

    override fun setFeatureScheduleDate(date: LocalDateTime?) {
        overViewFeatureScheduleRepository.setScheduleDate(date)
    }
