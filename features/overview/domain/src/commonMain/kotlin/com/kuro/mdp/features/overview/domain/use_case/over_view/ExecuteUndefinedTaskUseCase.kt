...
class ExecuteUndefinedTaskUseCase(
    ...
    suspend operator fun invoke(date: LocalDateTime, task: UndefinedTaskOverView): ResultState<OverViewAction> {
        ...
        return ResultState.Success(OverViewAction.Navigate)
    }
}