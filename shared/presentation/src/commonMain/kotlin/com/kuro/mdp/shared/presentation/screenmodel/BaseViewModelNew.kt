 ...
 * Description:
 */
abstract class BaseViewModelNew<S : BaseViewState, E : BaseEvent, A : BaseAction>(
    ...
    fun dispatchEvent(event: E) {
        viewModelScope.launch {
            this@BaseViewModelNew.event.emit(event)
        }
    }
    ...
    private fun collectEvent() {
        ...
        eventJob = viewModelScope.launch {
            this@BaseViewModelNew.event.collect { event -> handleEvent(event) }
        }
    }
